  ...
  return (
    ...
    >
      ...
      <View style={{ overflowY: 'auto' }}>
        <Paragraph>
          <Trans>
            Bread Chaser is a personal finance tool that focuses on beautiful
            design and a slick user experience.{' '}
        ...
        <Paragraph>
          <Trans>
            Currently, Bread Chaser implements budgeting based on a{' '}
            <Link
              variant="external"
        ...
        <Paragraph style={{ color: theme.pageTextLight }}>
          <Trans>
            Get started by importing an existing budget file from Bread Chaser
