...
export function ConfigServer() {
  ...
  function getErrorMessage(error: string) {
    switch (error) {
      ...
      default:
        return t(
          'Server does not look like a Bread Chaser server. Is it set up correctly?',
        );
    }
  }
          ...
          >
            {currentUrl ? (
              <Trans>
                ...
                server. We will validate that Bread Chaser is running at this
                URL.
              </Trans>
            ) : (
              <Trans>
                ...
                We will validate that Bread Chaser is running at this URL.
              </Trans>
            )}
          </Text>
          {error && (
