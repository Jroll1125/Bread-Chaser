...
function About() {
  ...
  return (
    <Setting>
      <Text>
        <Trans>
          <strong>Bread Chaser</strong> is a super fast privacy-focused app for
...
function AdvancedAbout() {
  ...
  return (
    <Setting>
      <Text>
        <Trans>
          <strong>IDs</strong> are the names Bread Chaser uses to identify your
